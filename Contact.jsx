        ...
        >
          <form className="w-full space-y-3 lg:space-y-5">
            ...
            >
              ...
              {/* Social Icons (NO MAP, NO GMAIL) */}
              <div className="flex items-center gap-x-2 lg:gap-x-5">
                {/* LinkedIn */}
                <motion.a
                  href="https://www.linkedin.com/in/mohith-kumar-netrambaku-852458303/"
                  target="_blank"
                ...
                {/* Twitter / X */}
                <motion.a
                  href="https://x.com/MohithK85203574"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white p-2 lg:p-3 rounded border-2 border-black"
                  whileHover={{ scale: 1.1, backgroundColor: "#000", color: "#fff" }}
                ...
                {/* GitHub */}
                <motion.a
                  href="https://github.com/mohis123"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white p-2 lg:p-3 rounded border-2 border-black"
                  whileHover={{ scale: 1.1, backgroundColor: "#000", color: "#fff" }}
